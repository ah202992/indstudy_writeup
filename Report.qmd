...
For the next data source, a similar study was conducted in the computer science field, where a semester long study of 50 students were separated into an experimental group that had access to Code Tutor, an LLM powered assistant made by the research team, and a control group with no access to the tool.
...
The next literary source focuses on the potential and cautions surrounding ChatGPT and its use in data science education, and only includes discussions about these topics, not a study of some kind.
...
Similar to Source 3, this article did not use experimental methods, but rather includes a discussion about ChatGPT and its role in data science education.
...
In another discussion and study on the future of education in data science and LLMs, Source 5 emphasizes the lack of experimentation in testing different types of LLM education platforms, claiming that there has only been theoretical discussions on the benefits and challenges of these systems.
...
In another discussion on data science education and Large Language Models, Source 6 dives into some theoretical use cases in the educational sphere.
...
To end the literature review, this last article published by Virginia Tech University introduces the Gurukul platform, a coding system developed by the research team that contains “Retrieval Augmented Generation and Guardrails” that prevents the model from providing explicit solutions to students.
...
1.  Chung, J., et al. "Evaluating the Effectiveness of LLMs in Introductory Computer Science Education: A Semester-Long Field Study.", 2024.

2.  Ellis, Amanda R., and Emily Slade.
    "A New Era of Learning: Considerations for ChatGPT as a Tool to Enhance Statistics and Data Science Education." Journal of Statistics and Data Science Education 31.2 (2023): 128–133.

3.  Pan, Youqin, and Jian Gu.
    "Empowering Education: ChatGPT's Role in Teaching and Learning Statistics and Data Analytics." International Journal of Technology in Teaching and Learning 19.1 (2023): 34–51.

4.  Schwarz, Joachim.
    "The Use of Generative AI in Statistical Data Analysis and Its Impact on Teaching Statistics at Universities of Applied Sciences." Teaching Statistics (2025).

5.  Tu, Xinming, et al. "What Should Data Science Education Do with Large Language Models." arXiv preprint arXiv:2307.02792 (2023).
...
From this evaluation, the ChatGPT-4o-mini model copied the feedback format the best, and this model was chosen moving forward.
...
TO DO: Add a sentence about what you learned from @gpt41.
